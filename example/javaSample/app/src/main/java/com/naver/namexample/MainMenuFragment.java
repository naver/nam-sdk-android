...
public class MainMenuFragment extends ListFragment {
  ...
  public View onCreateView(
    ...
    ArrayAdapter<SampleAdInfo> adapter =
        new ArrayAdapter<SampleAdInfo>(getActivity(), android.R.layout.simple_list_item_1, adList);
  ...
  public void onListItemClick(ListView listView, View view, int position, long id) {
    ...
    switch (adInfo.getAdType()) {
      ...
      default:
        Toast.makeText(
                this.getContext(), "[ERROR] Please check again your ad type", Toast.LENGTH_SHORT)
            .show();
    }
